...
>
  <span className='text-white font-gilroy'>Build with </span>{" "}
  <span
    style={{
  ...
  >
   ...
   <p className='text-white/40 text-base max-w-md mx-auto font-gilroy'>
...
<span
  className='text-xs font-gilroy font-[500]'
  style={{ color: lowCredits ? "#f87171" : "#818cf8" }}
>
...
<p className='text-sm text-red-300'>
  You need at least <span className='font-bold text-red-400'>50</span>{" "}
  credits to generate a component.
</p>
...
>
  ...
  onKeyDown={handleKeyDown}
    ...
    disabled={lowCredits}
    rows={3}
    className='w-full bg-transparent font-gilroy text-white placeholder-white/20 text-[15px] resize-none outline-none leading-relaxed disabled:cursor-not-allowed'
  />
</div>

<div className='flex items-center justify-between px-4 pb-3'>
  <span className='text-[13px] font-gilroy text-white/20'>
 ...
 onClick={handleGenerate}
  ...
  className='flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-normal font-gilroy disabled:opacity-40 disabled:cursor-not-allowed transition-all'
style={{
  ...
  boxShadow: generating
    ...
    : `
      ...
      0 8px 24px rgba(30,64,175,0.18)
    `,
  color: "#ffffff",
...
>
  <div className="flex items-center gap-3">
   ...
   <div>
  <p className="text-[15px] font-gilroy font-semibold text-white">
    {generated.name}
  </p>

  <p className="text-xs font-gilroy text-white/30">
...
<p className='text-white/20 font-gilroy text-[16px]'>
...
<p className='text-white/30 font-gilroy text-sm'>
