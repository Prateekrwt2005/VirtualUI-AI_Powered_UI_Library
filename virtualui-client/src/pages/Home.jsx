...
const steps = [
  {
    ...
    text: "npm install @prateekrwt07/virtualui to access all prebuilt UI components.",
  },
  {
    n: "02",
    ...
    >
      ...
      <nav className="sticky top-0 z-40 flex items-center justify-between px-4 sm:px-8 lg:px-10 py-4 border-b border-white/[0.05] bg-[#030b0d]/85 backdrop-blur-md">
        <div className="flex items-center gap-2.5">
          ...
          <span
            className="text-[22px] font-normal font-gilroy tracking-tight"
        ...
        <div className="hidden md:flex items-center gap-5 lg:gap-8 text-sm text-white/50">
          ...
          {userData ? (
            <div className="relative">
              ...
              >
                <div className="w-6 h-6 rounded-lg bg-gradient-to-br from-[#3be8ff] to-[#0ba5d4] flex items-center justify-center text-[#030b0d] text-[12px] font-bold font-gilroy">
                  {getLetters(userData?.name)}
                </div>

                <span className="text-white/80 text-m font-medium font-gilroy max-w-[100px] truncate">
                  {userData?.name}
                </span>
              </motion.button>
              ...
              <AnimatePresence>
                {profileOpen && (
                  <motion.div
                    ...
                    className="absolute right-0 top-14 w-55 bg-[#0a1a1e] border border-white/[0.09] rounded-2xl shadow-[0_16px_40px_rgba(0,0,0,0.5)] overflow-hidden z-50"
                  >
                    <div className="px-4 py-3.5 border-b border-white/[0.07]">
                      <p className="text-white/90 font-gilroy font-normal text-md truncate">
                        {userData?.name}
                      </p>

                      <p className="text-white/40  font-gilroy text-s truncate mt-0.5">
                        {userData?.email}
                      </p>
                    </div>
                    ...
                    <div className="border-t border-white/[0.07] py-1.5">
                      <button
                        ...
                        className="w-full flex items-center gap-3  font-gilroy px-4 py-2.5 text-m text-red-400/80 hover:text-red-400 hover:bg-red-500/[0.06] transition-colors cursor-pointer bg-transparent border-none text-left"
                      >
                        <TbLogout />
                        Logout
                      </button>
            ...
            <motion.button
              ...
              className="flex items-center gap-2 bg-[#3be8ff] text-[#030b0d] px-4 py-2 rounded-lg text-[16px] font-medium cursor-pointer border-none shadow-[0_0_20px_rgba(59,232,255,0.25)] hover:shadow-[0_0_30px_rgba(59,232,255,0.4)] transition-shadow  font-gilroy text-nowrap"
            >
              <HiSparkles size={16} />
            ...
            {userData ? (
              <>
                <div className="flex items-center gap-2.5 py-2 border-t border-white/[0.07]">
                  <div className="w-7 h-7 rounded-lg bg-gradient-to-br from-[#3be8ff] to-[#0ba5d4] flex items-center justify-center text-[#030b0d] text-[11px] font-bold  font-gilroy">
                    {getLetters(userData.name)}
                  </div>
                  <span className="text-white/80  font-gilroy text-[15px] font-medium">
                    {userData.name}
                  </span>
                </div>
                <button
                ...
                <button
                  ...
                  className="flex items-center gap-2 text-sm text-red-400/80 hover:text-red-400 transition-colors py-1 bg-transparent border-none cursor-pointer text-left  font-gilroy"
                >
                  <TbLogout size={15} />
                  Logout
                </button>
              ...
              <button
                onClick={() => setShowAuth(true)}
                className="flex items-center justify-center gap-2 bg-[#3be8ff] text-[#030b0d] px-4 py-2.5  font-gilroy rounded-lg text-sm font-semibold cursor-pointer border-none mt-1"
              >
                <HiSparkles size={14} />
                Generate AI Component
              </button>
      ...
      <section className="relative max-w-5xl mx-auto px-4 sm:px-6 pt-16 sm:pt-24 pb-12 sm:pb-20 text-center">
        <motion.div
          ...
          className="inline-flex items-center gap-2 text-[11px] font-semibold tracking-[2.5px] uppercase text-[#3be8ff]/70 border border-[#3be8ff]/20 bg-[#3be8ff]/[0.05] rounded-full px-4 py-1.5 mb-6 sm:mb-7"
        >
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-[1.08]  mb-5 sm:mb-6  font-gilroy"
        >
          Build React UI
          <br />
        ...
        <motion.p
          ...
          className="text-white/50 text-base sm:text-lg max-w-xl mx-auto leading-relaxed mb-8 sm:mb-10 font-light px-2  font-gilroy"
        >
        ...
        >
          <div className="flex items-center gap-2 sm:gap-3 bg-white/[0.04] border border-white/10 rounded-xl px-4 sm:px-5 py-3 text-xs sm:text-sm font-mono w-full max-w-xs sm:max-w-fit">
            ...
            <span className="text-white/80 truncate">
              npm install @prateekrwt07/virtualui
            </span>
            <button
              onClick={handleCopy}
        ...
        >
          ...
          <motion.button
            ...
            whileHover={{ y: -2 }}
            whileTap={{ scale: 0.97 }}
            className="flex items-center justify-center gap-2 px-6 sm:px-7 py-3.5 border border-white/15 rounded-xl text-white/70 hover:text-white hover:border-white/25 transition-all cursor-pointer  font-gilroy bg-transparent w-full sm:w-auto"
          >
            <HiSparkles size={14} />
            Generate AI Component
          </motion.button>
        ...
        >
          <div className="flex items-center gap-1.5 mb-4">
            ...
            <span className="ml-3 text-[13px] text-white/20 font-mono">
              App.jsx
            </span>
          </div>

          <div className="font-mono text-[11px] sm:text-[14px] leading-6 space-y-0.5 min-w-[280px]">
            <p>
              ...
              <span className="text-[#4aff80]/70">"virtual-ui-library"</span>
            ...
            <p>
              ...
              <span className="text-[#ffd166]">App</span>
              <span className="text-white/30">()</span>{" "}
              <span className="text-white/30">{"{"}</span>
            </p>

            <p className="pl-4">
              <span className="text-[#3be8ff]/60">return</span>{" "}
              <span className="text-white/30">(</span>
            </p>
            ...
            <p className="pl-8">
              ...
              <span className="text-[#4aff80]/60"> title</span>
              <span className="text-white/30">=</span>
              <span className="text-[#4aff80]/70">"Dashboard"</span>
              <span className="text-white/30">{">"}</span>
            </p>
            ...
            <p className="pl-12">
              ...
              <span className="text-[#4aff80]/60"> text</span>
              <span className="text-white/30">=</span>
              <span className="text-[#4aff80]/70">"hello"</span>
              <span className="text-white/30">{"/>"}</span>
            </p>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        ...
        >
          <p className="text-[11px] font-semibold tracking-[3px] uppercase text-[#3be8ff]/60 mb-3">
            What's inside
          </p>

          <h2 className="text-3xl sm:text-4xl  font-gilroy font-bold tracking-tight">
            Everything You Need
          </h2>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {features.map((item, index) => (
            ...
            >
              <div className="w-10 h-10 rounded-xl bg-[#3be8ff]/[0.08] border border-[#3be8ff]/15 flex items-center justify-center mb-4 group-hover:bg-[#3be8ff]/15 transition-colors font-gilroy">
                <item.icon size={18} className="text-[#3be8ff]" />
              </div>

              <h3 className="font-semibold font-gilroy text-white/90 mb-2 text-[15px]">
                {item.title}
              </h3>

              <p className="text-sm font-gilroy text-white/45 leading-relaxed">
                {item.text}
              </p>
            </motion.div>
          ))}
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 py-16 sm:py-24">
        <motion.div
          ...
          className="text-center mb-10 sm:mb-14"
        >
          <p className="text-[10px] font-semibold tracking-[3px] uppercase text-[#3be8ff]/60 font-gilroy mb-3">
            Simple process
          </p>

          <h2 className="text-3xl font-gilroy sm:text-4xl font-bold tracking-tight">
            How it works
          </h2>
        </motion.div>
          ...
          {steps.map((item, index) => (
            ...
            >
              <div className="w-14 h-14 sm:w-16 sm:h-16 mx-auto mb-4 sm:mb-5 rounded-2xl bg-gradient-to-br from-[#0e2528] to-[#071518] border border-[#3be8ff]/20 flex flex-col items-center justify-center group-hover:border-[#3be8ff]/40 group-hover:shadow-[0_0_20px_rgba(59,232,255,0.1)] transition-all duration-300">
                <span className="text-[9px] font-gilroy text-[#3be8ff]/60 font-bold tracking-widest">
                  {item.n}
                </span>
              </div>

              <h3 className="font-semibold font-gilroy text-white/90 mb-2 text-[13px] sm:text-[14px]">
                {item.title}
              </h3>

              <p className="text-[11px] font-gilroy sm:text-xs text-white/40 leading-relaxed">
                {item.text}
              </p>
            </motion.div>
          ))}
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 pb-16 sm:pb-24">
        ...
        >
          ...
          <div className="relative z-10">
            <p className="text-[10px] font-gilroy font-semibold tracking-[4px] uppercase text-[#3be8ff]/60 mb-3 sm:mb-4">
              Start building
            </p>
            <h3 className="text-3xl sm:text-4xl font-gilroy font-bold tracking-tight mb-3 sm:mb-4">
              Ready to generate
              <br />
              your new component?
            </h3>
            ...
            {userData ? (
              <>
                <p className="text-white/40 mb-7 sm:mb-8 text-sm  leading-relaxed font-gilroy">
                  Welcome back,{" "}
              ...
              <>
                <p className="text-white/40 mb-7 font-gilroy sm:mb-8 text-m max-w-130 mx-auto leading-relaxed">
      ...
      <footer className="border-t border-white/[0.05] py-8 sm:py-10">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4 sm:gap-0">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-lg font-gilroy font-medium tracking-tight">
              VirtualUI
            </span>
          </div>
          ...
          <p className="text-s text-white/25 order-last font-gilroy sm:order-none">
