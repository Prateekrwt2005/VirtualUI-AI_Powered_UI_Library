...
import {
  TbCode,TbEye,TbBox, TbCopy,TbCheck, TbPackage, TbBrandNpm, TbChevronRight, TbSearch,TbLayoutSidebarLeftExpand,TbX,TbMenu2,
} from "react-icons/tb";
...
<div>
  <p className="text-xs font-gilroy text-white/40 mb-2 flex items-center gap-1.5">
    <span className="text-[#3be8ff]/60 font-gilroy font-bold">03</span> Use in your App.jsx
  </p>
...
<div className="min-w-0">
  <h2 className="text-sm sm:text-base font-gilroy font-bold text-white truncate">
    {component.name}
  </h2>

  <p className="text-white/35 font-gilroy text-[11px] sm:text-xs mt-0.5 truncate">
...
>
  ...
  className="flex items-center gap-1 sm:gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-lg text-[11px] font-gilroy sm:text-xs font-medium transition-all capitalize cursor-pointer border-none whitespace-nowrap"
  style={{
    background: activeTab === id ? "rgba(59,232,255,0.15)" : "transparent",
    color: activeTab === id ? "#3be8ff" : "rgba(255,255,255,0.6)",
  }}
>
      <Icon size={11} /> {label}
    </button>
...
{activeTab === "guide" && (
  ...
  <th className="text-left px-4 py-2.5 font-gilroy text-white/35 font-medium">
    Name
  </th>
  <th className="text-left px-4 font-gilroy py-2.5 text-white/35 font-medium">
    Type
  </th>
</tr>
        </thead>
...
<div>
  ...
  <CodeBlock
    code={`npm install virtual-ui-library`}
    lang="bash"
  />
</div>
...
function SidebarComponent({
  publicComponents, selected,onSelect,search,setSearch,
}) {
  return (
    <>
   <div className="p-3 py-3 border-b border-white/[0.05]">
...
<div className="flex-1 overflow-y-auto py-1 px-2">
  ...
  >
    <span className="truncate font-gilroy font-medium text-xs">
  {c.name}
</span>
