...
<div className="relative z-10 max-w-5xl mx-auto px-4 py-14 w-full">
  <motion.button
    ...
    className="flex items-center gap-2 text-sm text-white/40 hover:text-white/70 font-gilroy transition-all mb-10 cursor-pointer bg-transparent border-none"
  >
...
>
  ...
  <span className="text-xs font-gilroy font-semibold tracking-widest text-indigo-300 uppercase">
    AI Credits
  </span>
</div>

<h1
  className="text-5xl sm:text-6xl font-gilroy font-extrabold mb-3"
  style={{
...
<p className="text-white/35 font-gilroy text-sm max-w-sm mx-auto">
  Choose a plan that fits your workflow. Credits are used
  each time you generate a component.
</p>
</motion.div>
...
<div className="flex items-center justify-between mb-5">
  <span
    className="text-xs font-gilroy font-semibold px-2.5 py-1 rounded-full"
    style={{
...
{plan.disabled && (
  <FiLock size={13} className="text-white/20 font-gilroy" />
)}
</div>

<h2
  className="text-xl font-gilroy font-bold mb-1"
 
>
  {plan.name}
</h2>

<p className="text-white/35 font-gilroy text-xs mb-5">
  {plan.description}
</p>
...
<div className="mb-6">
  ...
  <span
    className="text-5xl font-gilroy font-extrabold"
...
<div
  className="inline-flex font-gilroy items-center gap-1.5 mt-2 px-2.5 py-1 rounded-lg"
  style={{
...
<span
  className="text-xs font-gilroy font-normal"
  style={{
    color: plan.highlight ? "#06b6d4" : "rgba(255,255,255,0.4)",
  }}
>
...
<ul className="space-y-2.5 mb-8 flex-1">
  {plan.features.map((f) => (
    <li
      key={f}
      className="flex items-center font-gilroy gap-2.5 text-sm text-white/60"
    >
      <FiCheck
        size={13}
        style={{
          color: plan.highlight ? "#818cf8" : "rgba(255,255,255,0.3)",
        }}
      />
      {f}
    </li>
...
onClick={() => handlePayment(plan)}
  className="w-full py-3 rounded-xl font-gilroy text-m font-semibold"
  style={{
...
>
  {plan.disabled ? <div className="flex items-center justify-center gap-2">
  <FiCheck size={17} />
  {plan.cta}
</div> : plan.cta}
</button>
...
<motion.p
  ...
  className="text-center text-white/20 font-gilroy text-s mt-8"
>
