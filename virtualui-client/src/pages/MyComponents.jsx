...
{activeTab === "guide" && (
  <motion.div
    ...
    className="space-y-5"
  >
   <p className="text-[10px] font-bold font-gilroy tracking-[3px] uppercase text-[#3be8ff]/50">
  Usage Guide
</p>
...
<div>
  <p className="text-xs font-semibold font-gilroy text-white/50 mb-3 flex items-center gap-2">
    <TbCode size={13} />
    <span className="text-[#3be8ff]/70 font-gilroy font-bold">01</span>
...
<div>
  <p className="text-xs font-gilroy font-semibold text-white/50 mb-3 flex items-center gap-2">
    <TbCode size={13} />
    <span className="text-[#3be8ff]/70 font-gilroy font-bold">02</span>
    Create a new file
  </p>

  <CodeBlock code={`${component.name}.jsx`} lang="file" />
</div>

<div>
  <p className="text-xs font-semibold font-gilroy text-white/50 mb-3 flex items-center gap-2">
    <HiSparkles size={13} />
    <span className="text-[#3be8ff]/70 font-bold font-gilroy">03</span>
...
function SidebarComponent({
  myComponents, selected,onSelect,search,setSearch,
}) {
  return (
    <>
...
<div className="px-4 pt-3 pb-1.5">
  <p className="text-[9px] font-bold font-gilroy tracking-[2.5px] uppercase text-white/20">
    MyComponents · {myComponents.length}
  </p>
</div>
